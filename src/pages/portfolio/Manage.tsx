    ...
    <main className="max-w-screen-md lg:max-w-screen-xl px-8 pt-2 pb-4 md:px-10 lg:px-[5.25rem] lg:pt-0">
      ...
      <section className="pt-11">
        ...
        <p className="font-publicSans tracking-tight text-[0.95rem] leading-[1.875rem] text-left pt-6 pb-6 min-h-[11.75rem]">
          ...
          real-world coding problems. I've learned semothing new with each
...
{/* 
      ...
      <section className={`flex flex-col md:flex-row mt-80 md:justify-between md:items-center md:mt-2 md:mb-4 text-center`}>
